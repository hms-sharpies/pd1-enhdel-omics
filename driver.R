...
source(file.path(scRNA_script_dir, "03_gsea.R")) # ***WARNING, depending on compute power this can take about 15-ish hours to run, I haven't timed it though
source(file.path(scRNA_script_dir, "04_vision.R")) # ***WARNING
source(file.path(scRNA_script_dir, "05_pseudobulk.R"))
source(file.path(scRNA_script_dir, "07_motif_analysis.R"))
source(file.path(scRNA_script_dir, "08_off_target_analysis.R"))
