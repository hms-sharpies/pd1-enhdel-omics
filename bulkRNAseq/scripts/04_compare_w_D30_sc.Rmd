...
sample_D9_metadata_df <- read_tsv(here("bulkRNAseq", "processed_data_tables", "01_preprocessing.sample_metadata_D9_df.txt"))
gsea_D9_tcell <- read_tsv(here("bulkRNAseq", "processed_data_tables", "03_D9_signatures.gsea_tcell_D9_genotype.Enhdel.v.WT.txt"))
gsea_D9_bp <- read_tsv(here("bulkRNAseq", "processed_data_tables", "03_D9_signatures.gsea_bp_D9_genotype.Enhdel.v.WT.txt"))
```
...
```{r}
saveRDS(gsea_df, here("bulkRNAseq", "processed_data_objects", "04_compare_w_D30_sc.gsea_sc.bulk.harmonized.rds"))
```
