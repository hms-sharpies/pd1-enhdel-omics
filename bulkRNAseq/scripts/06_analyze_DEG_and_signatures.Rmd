...
```{r}
list.files(here("bulkRNAseq", "results")) %>% str_subset("norm")
...
# norm_counts_D9 <- readRDS(here("bulkRNAseq", "results", "deseq_norm_counts_D9_all_clusters_genotype.Enhdel.v.WT.rds"))
```
...
gsea_D9_tcell <- read_tsv(
  here("bulkRNAseq", "results", "gsea_tcell.exh_wide_D9_genotype.Enhdel.v.WT.txt")
)
gsea_D9_bp <- read_tsv(
...
```{r, fig.asp = 1, fig.width = 4}
my_plot_gsea_curve(gsea_res_bp, rank_lists, gs_subset_bp_list, "REACTOME_CELL_CYCLE", "progexh") + 
    ylim(-0.3, 0.3)
my_plot_gsea_curve(gsea_res_bp, rank_lists, gs_subset_bp_list, "REACTOME_CELL_CYCLE", "transexh") + 
    ylim(-0.3, 0.3)
my_plot_gsea_curve(gsea_res_bp, rank_lists, gs_subset_bp_list, "REACTOME_CELL_CYCLE", "termexh") + 
    ylim(-0.3, 0.3)
```

```{r, fig.asp = 1, fig.width = 4}
my_plot_gsea_curve(gsea_res_bp, rank_lists, gs_subset_bp_list, "HALLMARK_OXIDATIVE_PHOSPHORYLATION", "progexh") + 
    ylim(-0.3, 0.3)
my_plot_gsea_curve(gsea_res_bp, rank_lists, gs_subset_bp_list, "HALLMARK_OXIDATIVE_PHOSPHORYLATION", "transexh") + 
    ylim(-0.3, 0.3)
my_plot_gsea_curve(gsea_res_bp, rank_lists, gs_subset_bp_list, "HALLMARK_OXIDATIVE_PHOSPHORYLATION", "termexh") + 
    ylim(-0.3, 0.3)
```


```{r, fig.asp = 1, fig.width = 4}
my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EXHAUSTED_VS_MEMORY_CD8_TCELL_DN", "progexh") + 
  ylim(-0.23, 0.23)
my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EXHAUSTED_VS_MEMORY_CD8_TCELL_UP", "progexh") + 
  ylim(-0.23, 0.23)

my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EXHAUSTED_VS_MEMORY_CD8_TCELL_DN", "transexh") + 
  ylim(-0.23, 0.23)
my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EXHAUSTED_VS_MEMORY_CD8_TCELL_UP", "transexh")  + 
  ylim(-0.23, 0.23)

my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EXHAUSTED_VS_MEMORY_CD8_TCELL_DN", "termexh") + 
  ylim(-0.23, 0.23)
my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EXHAUSTED_VS_MEMORY_CD8_TCELL_UP", "termexh") + 
  ylim(-0.23, 0.23)
```

```{r, fig.asp = 1, fig.width = 4}
my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EFFECTOR_VS_EXHAUSTED_CD8_TCELL_DN", "progexh") + 
  ylim(-0.23, 0.23)
my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EFFECTOR_VS_EXHAUSTED_CD8_TCELL_UP", "progexh") + 
  ylim(-0.23, 0.23)

my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EFFECTOR_VS_EXHAUSTED_CD8_TCELL_DN", "transexh") + 
  ylim(-0.23, 0.23)
my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EFFECTOR_VS_EXHAUSTED_CD8_TCELL_UP", "transexh") + 
  ylim(-0.23, 0.23)

my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EFFECTOR_VS_EXHAUSTED_CD8_TCELL_DN", "termexh") + 
  ylim(-0.23, 0.23)
my_plot_gsea_curve(gsea_res_tcell, rank_lists, gs_subset_tcell_list, "GSE9650_EFFECTOR_VS_EXHAUSTED_CD8_TCELL_UP", "termexh") + 
  ylim(-0.23, 0.23)
```
...
# gsea_res_bp_filtered <- gsea_res_bp %>%
#   filter(q.val_progexh < 0.05 & q.val_transexh < 0.05 &
#            q.val_termexh < 0.05) %>%
#   dplyr::select(gs_name, str_subset(colnames(.), "sscore"))
# View(gsea_res_bp_filtered)

# gsea_res_tcell_filtered <- gsea_res_tcell %>%
  # filter(q.val_progexh < 0.05 & q.val_transexh < 0.05 &
  #          q.val_termexh < 0.05) %>%
  # dplyr::select(gs_name, str_subset(colnames(.), "sscore"))
# View(gsea_res_tcell_filtered)
