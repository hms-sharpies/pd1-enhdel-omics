...
sample_metadata_df <- read_tsv(here("bulkRNAseq", "results", "sample_metadata_D30_df.txt"))
...
write_tsv(dge_exh.prog.vs.term,
          here("bulkRNAseq", "results", "dge_D30_exh.prog.vs.term.txt"))
...
write_tsv(results_list$progenitor,
          here("bulkRNAseq", "results", "dge_D30_progexh_genotype.Enhdel.v.WT.txt"))
write_tsv(results_list$transitory,
          here("bulkRNAseq", "results", "dge_D30_transexh_genotype.Enhdel.v.WT.txt"))
write_tsv(results_list$terminal,
          here("bulkRNAseq", "results", "dge_D30_termexh_genotype.Enhdel.v.WT.txt"))
