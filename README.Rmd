...
## Contents
 ...
 - `bulkRNAseq`: directory containing the data and scripts for reproducing bulk RNA-seq analyses and figures
...
4. Download the bulk RNAseq counts `transcript_counts.tsv` from the Single Cell Portal and place them in the `bulkRNAseq/data` directory. 
...
* bulkRNAseq/data/transcript_counts.tsv
